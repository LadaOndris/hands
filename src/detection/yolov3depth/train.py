...
from src.detection.yolov3depth.preprocessing import DatasetPreprocessor
from src.utils.config import TRAIN_YOLO_IOU_IGNORE_THRES
from src.utils.paths import HANDSEG_DATASET_DIR, YOLO_DEPTH_CONFIG_FILE


def train(batch_size, learning_rate, train_size=0.8, decay_rate=0.94):
    loader = YoloLoader(batch_size)
    model = loader.parse_cfg(YOLO_DEPTH_CONFIG_FILE)
