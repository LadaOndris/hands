...
from src.gestures.relative_distance.base import hand_orientation, joint_relation_errors, vectors_angle
...
class RelativeDistanceGestureRecognizer(GestureRecognizer):
    """
    ...
    def recognize(self, keypoints_xyz: np.ndarray) -> GestureRecognitionResult:
        ...
        and decides whether the hand satisfies some of the defined gesture_recognizers.
